...
namespace SpectreMod.Content.Items.Charms
{
    public class StardustCharm : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(line);
            line = new TooltipLine(Mod, "Damage", $"Current Level Progress: {totalDamageModifier}/{LevelCost(level + 1)}");
            line.OverrideColor = Color.LimeGreen;
    ...
    public class CharmStardustPlayer : ModPlayer
    {
        ...
        internal void AccumulateDamageModifier(long damage)
        {
            ...
            if (IsActive && charmStardust.level < StardustCharm.MaxLevel && charmStardust.totalDamageModifier > StardustCharm.LevelCost(charmStardust.level + 1))
            {
                charmStardust.level++;
